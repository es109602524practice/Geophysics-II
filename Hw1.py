    ...
    fig = pygmt.Figure()
    fig.grdimage(grid, region=region, projection='W0/15c', cmap='ETOPO1.cpt')
    fig.coast(region=region, projection="W0/15c",
    ...
    sample_points_lon, sample_points_lat = [-169, -122, -110], [52, 38, 26]
